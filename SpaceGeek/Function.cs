...
namespace SpaceGeek
{
    public class Function
    {
        ...
        private List<FactResource> GetResources()
        {
            ...
            var enUSResource = new FactResource("en-US");
        ...
        private string EmitNewFact(FactResource resource, bool withPreface)
        {
            var stringBuilder = new StringBuilder();
            if (withPreface)
            {
                stringBuilder.Append(resource.GetFactMessage);
            }

            var random = new Random();
            stringBuilder.Append(resource.Facts[random.Next(resource.Facts.Count)]);
